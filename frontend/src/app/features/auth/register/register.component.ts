    ...
    <div class="auth-page">
      <div class="auth-card">
        <div class="auth-header">
          ...
          <p>Get started with ModdersOmni</p>
        </div>
          ...
          <div class="form-group">
            ...
            @if (password.length > 0) {
              ...
              <span class="strength-label">
                @if (passwordStrength() < 40) { Weak }
                @else if (passwordStrength() < 70) { Medium }
                @else { Strong }
              </span>
            }
          </div>
  ...
  onSubmit(): void {
    ...
    this.authService
      ...
      .subscribe({
        ...
        error: (err) => {
          this.loading.set(false);
          this.notifications.error(err.error?.detail || 'Registration failed');
        },
      });
  }
